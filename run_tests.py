...
Initially Generated By:
    python -m utool --tf setup_repo --repo=ibeis-curverank-module --codedir=~/code --modname=ibeis_curverank
"""
...
def run_tests():
    ...
    import sys
    ut.change_term_title('RUN ibeis_curverank TESTS')
