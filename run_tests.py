...
Initially Generated By:
    python -m utool --tf setup_repo --repo=ibeis-curvrank-module --codedir=~/code --modname=ibeis_curvrank
"""
...
def run_tests():
    ...
    import sys
    ut.change_term_title('RUN ibeis_curvrank TESTS')
